...
/// @brief ゾンビエネミー
class ZombieEnemy final : public Actor
{
public:

	[[nodiscard]] ZombieEnemy(const string& uniqueKey);
	virtual ~ZombieEnemy() = default;
...
private:
	...
	optional<reference_wrapper<CylinderCollider>> collider_;		/// @brief オンオフ切り替えるためのコライダー情報保持
